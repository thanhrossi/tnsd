...
function optionsframework_menu_settings() {
	...
	$menu = array(
		'page_title' => __( 'TT theme options', 'optionsframework'),
		'menu_title' => __('<img src="http://i.imgur.com/SJI2Mr4.png" width="10px" height="10px"/>-Theme options', 'optionsframework'),
